...
- [ ] Инициализация Next.js с TypeScript и App Router
...
- [ ] Создание базовых компонентов UI (кнопки, поля ввода, карточки)

### 1.3. Базовая навигация
- [ ] Создание макета приложения (layout)
- [ ] Реализация навигационной панели
- [ ] Создание основных страниц (главная, переводчик, карточки, профиль)
